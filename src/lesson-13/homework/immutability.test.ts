import { OriginalTeam, ExpectedTeam, originalTeamToExpectedTeam, originalArrayToExpectedArray, deepOriginalTeamToExpectedTeam } from "./immutability";
...
test("team to team deep", () => {
	...
	expect(deepOriginalTeamToExpectedTeam(originalTeam)).toEqual(expectedTeam);
});
